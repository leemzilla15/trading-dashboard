...
const helmetOptions = {
  contentSecurityPolicy: {
    directives: {
      defaultSrc:  ["'self'"],
      scriptSrc:   ["'self'", "'unsafe-inline'", "'unsafe-eval'", 'cdn.tailwindcss.com', 'fonts.googleapis.com', 's3.tradingview.com', '*.tradingview.com', 'charting_library.tradingview.com'],
      scriptSrcAttr: ["'unsafe-inline'"],
      styleSrc:    ["'self'", "'unsafe-inline'", 'fonts.googleapis.com', 'fonts.gstatic.com', '*.tradingview.com'],
      fontSrc:     ["'self'", 'fonts.gstatic.com', '*.tradingview.com'],
      connectSrc:  ["'self'", 'https://api.anthropic.com', 'https://finnhub.io', 'https://nfs.faireconomy.media', '*.tradingview.com', 'wss://*.tradingview.com'],
      imgSrc:      ["'self'", 'data:', '*.tradingview.com', 'https:'],
      frameSrc:    ["'self'", '*.tradingview.com'],
      workerSrc:   ["'self'", 'blob:', '*.tradingview.com'],
      objectSrc:   ["'none'"],
    },
  },
  // Allow the dashboard to be embedded in iframes from same origin
